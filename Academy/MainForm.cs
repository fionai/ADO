	...
	public partial class MainForm : Form
	{
		...
		private void tabControl_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			switch (tabControl.SelectedIndex)
			{
				...
				case 3: toolStripStatusLabel.Text = $"Количество дисциплин: {dgvDisciplines.RowCount - 1}"; break;
				case 4: toolStripStatusLabel.Text = $"Количество преподавателей: {dgvTeachers.RowCount - 1}"; break;
			}
